...
public class DataConfig {
    ...
    private static final String MYSQL_HOST = "coolbhu.cn";
    private static final String MYSQL_URL = "jdbc:mysql://" + MYSQL_HOST + ":3306/basefind?useUnicode=true&characterEncoding=UTF-8";
